...
- Используя CString, Rust работает с utf-8, в то время как node.js использует utf-16. Нам пришлось создать специальные функции для перевода кодировок из одной в другую при подаче/выводе данных.
